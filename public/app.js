...
async function main() {
  if (!MAPBOX_TOKEN || MAPBOX_TOKEN.includes("REPLACE_ME")) {
    showErrorBanner("Missing Mapbox token: set MAPBOX_TOKEN in public/app.js before publishing.");
    return;
  }
  ...
  map.on("load", async () => {
    ...
    map.on("mousemove", LAYER_ID, (e) => {
      ...
      // Mapbox returns properties as strings; coerce numbers where needed
      const props = { ...p };
